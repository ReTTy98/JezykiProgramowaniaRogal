...
public class Book implements Comparable<Book> {
    ...
    public static Book fromFile(BufferedReader reader) throws BookException, FileNotFoundException{
        try {
            final String line = reader.readLine();
            final String[] text = line.split(";");
            final Book book = new Book(text[0],text[1]);
    ...
    public String toString() {
    	return String.valueOf(this.title) + "" + this.author;
    }
	...
	public int compareTo(final Book b) {
		...
		if (result == 0) {
            ...
            if (result == 0 ) {
                result = this.getDateOfPublication().compareTo(b.getDateOfPublication());
            }
		}
		return result;
	}
