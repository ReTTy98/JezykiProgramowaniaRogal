/*
    Program: Aplikacja okienkowa z GUI umożliwiająca testowanie działania programu Book

    plik: UserDialogWindow.java

    klasa UserDialogWindow.java odpowiedzialna jest za wyskakujace okienko 
    pojawiajace sie w momencie klikniecia opcji "add", lub "modify"
